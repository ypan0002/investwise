...
(function ($) {
    ...
    Plugin.prototype = {
        ...
        mouseDown: function (e) {
            if (e.which === 1 && ! e.target.classList.contains( 'themify_module_favorite' ) && ! e.target.classList.contains( 'add_module_btn' ) && ! e.target.classList.contains( 'remove_item_btn' ) ) {
