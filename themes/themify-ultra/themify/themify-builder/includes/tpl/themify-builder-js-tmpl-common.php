...
<script type="text/html" id="tmpl-builder_lightbox">
	...
	<div id="themify_builder_lightbox_parent" class="themify_builder themify_builder_admin builder-lightbox {{ data.is_themify_theme }}">
...
<script type="text/html" id="tmpl-builder_row_item">
	<div class="themify_builder_row_top tb_top">
		...
		<ul class="row_action">
			...
			<li><a href="#" class="themify_builder_save_component themify-tooltip-bottom"  data-component="row">
					<span class="ti-save"></span>
					<span class="themify_tooltip"><?php _e('Save', 'themify') ?></span>
				</a></li>
...
<script type="text/html" id="tmpl-builder_layoutpart_lightbox">
	<div class="tb_layoutpart_lightbox">
		<iframe src="{{ data.link }}" name="layoutpart_link" id="layoutpart_link">Your Browser doesn't support iframe.</frame>
	</div>
</script>
