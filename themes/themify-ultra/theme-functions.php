...
function themify_is_navigation_bar() {
	//exclusively created for header classic and header magazine navigation bar option
	return themify_get( 'header_design' ) == "header-classic" // per-post option
	|| (themify_get( 'header_design' ) == '' && themify_get( 'setting-header_design' ) === 'header-classic') // global setting 
	|| themify_get( 'header_design' ) == "header-magazine" // per-post option
	|| (themify_get( 'header_design' ) == '' && themify_get( 'setting-header_design' ) === 'header-magazine'); // global setting
}
